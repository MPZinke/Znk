...
for(int x = 0; x < MAX_SYMBOL_COUNT; x++) LENGTH_FUNCTIONS[x] = NULL;
...
// LENGTH_FUNCTIONS[GLOBABL_SYMBOL] = globabl_symbol_length;
...
// ———— OPERATORS
// ———— OPERATORS::ASSIGN
// LENGTH_FUNCTIONS[_OPERATOR] = _operator_length;
